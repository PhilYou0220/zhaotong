...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_035_moat_org_position_details.yml")
api_name = "moat_org_position_details"


@allure.epic("组织管理--部门与成员--职位详情")
class TestMoatOrgPositionDetails:
