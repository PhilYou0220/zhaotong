...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_049_boss_companys.yml")
api_name = "boss_companys"


@allure.epic("企业管理--矿企管理--列表")
class TestMoatOrgFullTree:

    @allure.title("企业管理--矿企管理--默认列表")
    @pytest.mark.api
    ...
    @allure.title("企业管理--矿企管理--关键字及区域搜索")
    @pytest.mark.api
