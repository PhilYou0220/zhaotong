...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_054_boss_weight_data_point_tree.yml")
api_name = "boss_weight_data_point_tree"


@allure.epic("销售数据管理--联单审核树")
class TestMoatOrgFullTree:

    @allure.title("销售数据管理--联单审核树")
    @pytest.mark.api
