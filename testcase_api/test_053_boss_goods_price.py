...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_053_boss_goods_price.yml")
api_name = "boss_goods_price"


@allure.epic("销售数据管理--非煤矿价格及税收管理--修改详情")
class TestMoatOrgFullTree:

    @allure.title("销售数据管理--非煤矿价格及税收管理--修改详情")
    @pytest.mark.api
