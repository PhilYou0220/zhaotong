...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_030_moat_org_general_tree.yml")
api_name = "moat_org_general_tree"


@allure.epic("组织管理--部门与成员--组织")
class TestMoatOrgGeneralTree:

    @allure.title("组织管理--部门与成员--组织")
    @pytest.mark.api
