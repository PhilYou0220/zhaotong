...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_046_boss_car_inout_datas.yml")
api_name = "boss_car_inout_datas"


@allure.epic("矿山数据统计--销售数据核准--列表及搜索")
class TestMoatOrgFullTree:

    @allure.title("矿山数据统计--销售数据核准--列表及搜索")
    @pytest.mark.api
