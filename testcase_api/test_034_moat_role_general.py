...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_034_moat_role_general.yml")
api_name = "moat_role_general"


@allure.epic("组织管理--部门与成员--所有角色")
class TestMoatRoleGeneral:

    @allure.title("组织管理--部门与成员--所有角色")
    @pytest.mark.api
    # @pytest.mark.run(order=1)
    def test_moat_role_general_0(cls):
        case_index = 0
