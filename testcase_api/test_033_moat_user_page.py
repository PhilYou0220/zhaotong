...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_033_moat_user_page.yml")
api_name = "moat_user_page"


@allure.epic("组织管理--部门与成员--具体职位下的所有用户")
class TestMoatUserPage:

    @allure.title("组织管理--部门与成员--具体职位下的所有用户")
    @pytest.mark.api
    # @pytest.mark.run(order=1)
    def test_moat_user_page_0(cls):
        case_index = 0
