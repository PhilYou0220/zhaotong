...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_032_moat_org_full_child_tree.yml")
api_name = "moat_org_full_child_tree"


@allure.epic("组织管理--部门与成员--所有部门")
class TestMoatOrgFullChildTree:

    @allure.title("组织管理--部门与成员--所有部门")
    @pytest.mark.api
    # @pytest.mark.run(order=1)
    def test_moat_org_full_child_tree_0(cls):
        case_index = 0
