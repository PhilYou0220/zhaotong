...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_003_patrol_daily_patrol_list.yml")
api_name = "patrol_daily_patrol_list"


@allure.epic("指挥中心左部日常巡检")
class TestPatrolDailyPatrolList:
