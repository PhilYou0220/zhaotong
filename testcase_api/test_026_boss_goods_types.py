...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_026_boss_goods_types.yml")
api_name = "boss_goods_types"


@allure.epic("税收监管--识别能力")
class TestBossPointTree:

    @allure.title("税收监管--识别能力")
    @pytest.mark.api
    # @pytest.mark.run(order=1)
    def test_boss_point_tree_0(cls):
        case_index = 0
