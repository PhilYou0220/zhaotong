...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_080_boss_belt_data_belt_summary_data.yml")
api_name = "boss_belt_data_belt_summary_data"


@allure.epic("矿山数据统计--加工销售数据统计")
class TestMoatOrgFullTree:

    @allure.title("矿山数据统计--加工销售数据统计列表")
    @pytest.mark.api
    ...
    @allure.title("矿山数据统计--加工销售数据统计列表筛选")
    @pytest.mark.api
