...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_008_boss_ticket_count_by_point.yml")
api_name = "boss_ticket_count_by_point"


@allure.epic("指挥中心顶部数据销售量详情")
class TestBossTicketCountByPoint:
