...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_022_boss_ticket_tax_by_time.yml")
api_name = "boss_ticket_tax_by_time"


@allure.epic("税收监管--顶部看板")
class TestBossTicketTaxByTime:

    @allure.title("税收监管--顶部看板--市级")
    @pytest.mark.api
