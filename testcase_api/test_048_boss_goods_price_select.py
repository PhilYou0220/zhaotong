...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_048_boss_goods_price_select.yml")
api_name = "boss_goods_price_select"


@allure.epic("矿山数据统计--销售数据核准--详情--产品名称")
class TestMoatOrgFullTree:

    @allure.title("矿山数据统计--销售数据核准--详情--产品名称")
    @pytest.mark.api
