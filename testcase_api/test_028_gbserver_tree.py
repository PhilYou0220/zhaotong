...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_028_gbserver_tree.yml")
api_name = "gbserver_tree"


@allure.epic("视频监控--视频监控树")
class TestGbserverTree:

    @allure.title("视频监控--视频监控树")
    @pytest.mark.api
