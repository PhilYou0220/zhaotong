...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_060_boss_belt_data_trend.yml")
api_name = "boss_belt_data_trend"


@allure.epic("销售数据管理--加工量--皮带秤流速和流量")
class TestMoatOrgFullTree:

    @allure.title("销售数据管理--加工量--皮带秤流速和流量")
    @pytest.mark.api
