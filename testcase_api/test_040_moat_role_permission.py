...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_040_moat_role_permission.yml")
api_name = "moat_role_permission"


@allure.epic("组织管理--角色管理--具体角色权限树")
class TestMoatOrgFullTree:

    @allure.title("组织管理--角色管理--具体角色权限树")
    @pytest.mark.api
