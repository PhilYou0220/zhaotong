...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_036_moat_org_full_tree.yml")
api_name = "moat_org_full_tree"


@allure.epic("组织管理--部门与成员--编辑成员--部门职位选项")
class TestMoatOrgFullTree:

    @allure.title("组织管理--部门与成员--编辑成员--部门职位选项")
    @pytest.mark.api
