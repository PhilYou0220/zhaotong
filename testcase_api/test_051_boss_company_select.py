...
# 搞两个全局变量指定用例文件及接口名称
filename = os.path.join(CASEYAML, "test_051_boss_company_select.yml")
api_name = "boss_company_select"


@allure.epic("企业管理--矿企管理--编辑时的关联企业选择")
class TestMoatOrgFullTree:

    @allure.title("企业管理--矿企管理--编辑时的关联企业选择")
    @pytest.mark.api
